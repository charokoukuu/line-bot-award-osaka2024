...
export default function privacy() {
  return (
    <>
      <main>
        <div className="japanese_L m-3">
          <div className="mx-auto max-w-3xl rounded-lg bg-white p-[2%] [&_h2]:my-[0.83em] [&_h2]:text-[1.5em] [&_h2]:font-bold [&_li]:list-decimal [&_ul]:ml-4 [&_ul_ul>li]:list-[lower-latin] [&_ul_ul_ul>li]:ml-4 [&_ul_ul_ul>li]:list-[cjk-ideographic]">
